...
mx["mx1"] = fuzz.trimf(mx.universe, [-0.2, 0, 0.2])
mx["mx2"] = fuzz.trimf(mx.universe, [0, 0.2, 0.4])
...
my["my1"] = fuzz.trimf(my.universe, [-0.2, 0, 0.2])
my["my2"] = fuzz.trimf(my.universe, [0, 0.2, 0.4])
...
for i in range(9):
    mf[f"mf{i+1}"] = fuzz.trimf(mf.universe, [0.9 + (0.11 * (i-1)), 0.9 + 0.11 * i, 0.9 + (0.11 * (i+1))])
